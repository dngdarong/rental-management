                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($rents as $rent) {{-- Corrected loop variable to $rents --}}
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="{{ route('admin.rents.invoice.pdf', $rent) }}" target="_blank" class="text-blue-600 hover:text-blue-900 mr-3">PDF</a> {{-- Added PDF button --}}
