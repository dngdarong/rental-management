...
<head>
    ...
    <title>Forgot Password - Rental Management</title>
    <!-- Tailwind CSS CDN -->
    ...
    <style>
        ...
        /* Custom styles for the forgot password card */
        ...
        .forgot-password-card .message-box {
        ...
        .forgot-password-card .primary-button {
        ...
        .forgot-password-card .primary-button:hover {
    ...
    <div class="forgot-password-card">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="mb-6">
                ...
                <x-text-input id="email" class="block mt-2 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" type="email" name="email" :value="old('email')" required autofocus />
